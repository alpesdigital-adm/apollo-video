...
| FR-133 | Long-form indexing | S3 | D1,D2,D4 | workflow probe→transcript→diarization→chunks→moments com checkpoints, parcial pesquisável, budget e retomada sem duplicação | T-FR-133 state machine 6 casos; persistência/API/worker/E2E/deploy pendentes |
