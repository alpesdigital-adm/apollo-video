...
test('T-AC-001..016 executes the complete MVP Core gate with automatic evidence', async () => {
  ...
  const annotation = createReviewAnnotation({ id: 'ann-1', projectVersionId: 'v1', frame: 30, timeRangeMs: [1000, 2000], region: { x: .1, y: .1, width: .2, height: .2 }, targetIds: ['insert-1'], text: 'Trocar insert', status: 'open', createdAt: '2026-07-17T00:00:00.000Z' })
