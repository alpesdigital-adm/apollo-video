...
test('T-AC-001..016 executes the complete MVP Core gate with automatic evidence', async () => {
  ...
  const proposal = proposePatchFromAnnotation({ annotation, baseVersionId: 'v1', interpretations: [{ op: 'replace-asset', targetId: 'insert-1', rangeMs: [1000, 2000], value: { assetId: 'asset-2' } }], protectedTargetIds: [], policyAllowedOps: ['replace-asset'], budgetRemaining: 10, estimatedCost: 1 })
