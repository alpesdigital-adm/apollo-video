...
-- Synthetic production renders use the same four durable render phases as
-- every other render operation. Keep this type-specific progress contract in
-- lockstep with the PublicOperation domain instead of weakening the global
-- status/phase/progress relationship.
ALTER TABLE "public_operations"
