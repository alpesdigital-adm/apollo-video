...
ALTER TABLE "montage_alternative_runs" ADD CONSTRAINT "montage_alternative_runs_storyPlan_ref_fkey" FOREIGN KEY ("storyPlanId", "workspaceId", "projectId", "storyPlanHash") REFERENCES "story_plans"("id", "workspaceId", "projectId", "storyHash") ON DELETE RESTRICT ON UPDATE CASCADE;
