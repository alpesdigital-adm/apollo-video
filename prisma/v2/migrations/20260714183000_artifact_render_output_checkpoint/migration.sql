ALTER TABLE "artifact_render_operations"
  ...
  ADD COLUMN "outputSha256" CHAR(64),
  ADD COLUMN "outputByteSize" BIGINT,
  ADD COLUMN "outputWidth" INTEGER,
  ADD COLUMN "outputHeight" INTEGER,
  ADD COLUMN "outputFps" DOUBLE PRECISION,
  ADD COLUMN "outputDurationInFrames" INTEGER,
  ADD COLUMN "outputCodec" VARCHAR(32),
  ADD COLUMN "outputContainer" VARCHAR(32),
  ADD COLUMN "outputAttempt" INTEGER,
  ADD COLUMN "outputCommittedAt" TIMESTAMPTZ(3),
  ADD COLUMN "outputRecordedAt" TIMESTAMPTZ(3),
  ADD CONSTRAINT "artifact_render_operations_output_check" CHECK (
    ...
    OR (
      "outputKey" ~ '^[A-Za-z0-9][A-Za-z0-9._/-]{0,510}\.mp4$'
