...
export const FOUNDATION_CAPABILITIES = defineCapabilityRegistry([
  ...
  },
  {
    ...
    description: 'Applies a typed editorial command against an immutable base version. Supports spoken-content removal, explicit immutable source-transcript replacement that blocks render until recomputation, and a complete DirectorRun that persists perception, treatment, story, EditPlan and critic snapshots before queuing a proxy.',
    exposure: 'public',
    operationKind: 'command',
    authMode: 'required',
    requiredScopes: ['projects:write'],
    inputSchemaRef: 'apollo://schemas/apply-project-edit-command-request/v4',
    outputSchemaRef: 'apollo://schemas/project-edit-command-applied/v3',
