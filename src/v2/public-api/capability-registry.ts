...
export const FOUNDATION_CAPABILITIES = defineCapabilityRegistry([
  ...
  },
  {
    ...
    description: 'Returns the active immutable preview identity, scene ranges and persisted review annotations for one project.',
    exposure: 'public',
    operationKind: 'query',
    authMode: 'required',
    requiredScopes: ['projects:read'],
    outputSchemaRef: 'apollo://schemas/project-review/v1',
  ...
  },
  {
    ...
    description: 'Persists one point, region or scene annotation against the exact active ProjectVersion and proxy hash without mutating the edit.',
    exposure: 'public',
    operationKind: 'command',
    authMode: 'required',
    requiredScopes: ['projects:write'],
    inputSchemaRef: 'apollo://schemas/create-review-annotation-request/v1',
    outputSchemaRef: 'apollo://schemas/review-annotation-created/v1',
