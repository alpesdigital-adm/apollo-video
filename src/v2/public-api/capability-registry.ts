...
export const FOUNDATION_CAPABILITIES = defineCapabilityRegistry([
  ...
  },
  {
    ...
    authMode: 'required',
    requiredScopes: ['operations:read'],
    outputSchemaRef: 'apollo://schemas/public-operation-list/v8',
    ...
    queryParameters: [
      ...
      },
      {
        ...
        required: false,
        schema: { type: 'string', enum: ['artifact-render', 'media-ingest', 'project-proxy-render', 'project-final-export', 'source-cleanup', 'long-form-index'] },
      },
      {
        name: 'projectId',
  ...
  },
  {
    ...
    authMode: 'required',
    requiredScopes: ['operations:read'],
    outputSchemaRef: 'apollo://schemas/public-operation-detail/v8',
