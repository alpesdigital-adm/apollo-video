...
export const FOUNDATION_CAPABILITIES = defineCapabilityRegistry([
  ...
  },
  {
    ...
    description: 'Preflights a bounded Director tool batch against server-derived scope, rights, budget and base version before invoking application services.',
    exposure: 'public',
    operationKind: 'preflight',
    authMode: 'required',
    requiredScopes: ['projects:write'],
    inputSchemaRef: 'apollo://schemas/director-tool-execution-request/v2',
    outputSchemaRef: 'apollo://schemas/director-tool-execution/v1',
