...
export const FOUNDATION_CAPABILITIES = defineCapabilityRegistry([
  ...
  },
  {
    ...
    description: 'Applies a typed editorial command against an immutable base version. Spoken-content removal persists a full-timeline impact and exact stale output relationships before proxy enqueue; source-transcript replacement blocks render until recomputation; DirectorRun persists perception, treatment, story, EditPlan and critic snapshots before queuing a proxy.',
    exposure: 'public',
    operationKind: 'command',
    authMode: 'required',
    requiredScopes: ['projects:write'],
    inputSchemaRef: 'apollo://schemas/apply-project-edit-command-request/v4',
    outputSchemaRef: 'apollo://schemas/project-edit-command-applied/v4',
