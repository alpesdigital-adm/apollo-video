...
export const FOUNDATION_CAPABILITIES = defineCapabilityRegistry([
  ...
  },
  {
    ...
    outputSchemaRef: 'apollo://schemas/review-patch-applied/v2',
  ...
  },
  {
    ...
    outputSchemaRef: 'apollo://schemas/artifact-detail/v2',
  ...
  },
  {
    ...
    outputSchemaRef: 'apollo://schemas/public-operation-list/v6',
  ...
  },
  {
    ...
    authMode: 'required',
    requiredScopes: ['operations:read'],
    outputSchemaRef: 'apollo://schemas/public-operation-detail/v6',
  ...
  },
  {
    ...
    authMode: 'required',
    requiredScopes: ['projects:read'],
    outputSchemaRef: 'apollo://schemas/project-artifact-invalidations/v1',
  ...
  },
  {
    ...
    outputSchemaRef: 'apollo://schemas/project-version-comparison-action-result/v2',
  ...
  {
    id: 'apollo.projects.lut-selection.read', version: '2.0.0', title: 'Read project LUT selection',
    ...
    exposure: 'public', operationKind: 'query', authMode: 'required', requiredScopes: ['projects:read'],
    outputSchemaRef: 'apollo://schemas/project-lut-selection-response/v2', endpoint: { method: 'GET', path: '/v1/projects/{projectId}/lut-selection' }, toolName: 'apollo.projects.lut-selection.read',
    supportsDryRun: false, costClass: 'free', confirmation: 'none', successStatuses: [200], idempotency: 'not-applicable',
  },
  {
    id: 'apollo.projects.lut-selection.set', version: '2.0.0', title: 'Set project LUT selection',
    ...
    exposure: 'public', operationKind: 'command', authMode: 'required', requiredScopes: ['projects:write'],
    inputSchemaRef: 'apollo://schemas/project-lut-selection-set-request/v1', outputSchemaRef: 'apollo://schemas/project-lut-selection-applied/v2',
