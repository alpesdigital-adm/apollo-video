...
export const FOUNDATION_CAPABILITIES = defineCapabilityRegistry([
  ...
  },
  {
    ...
    description: 'Solves content-addressed format-specific anchors, bounds, protected regions, collision avoidance and review fallbacks for one output canvas.',
    exposure: 'public',
    operationKind: 'preflight',
    authMode: 'required',
    requiredScopes: ['projects:read'],
    inputSchemaRef: 'apollo://schemas/responsive-placement-request/v1',
    outputSchemaRef: 'apollo://schemas/responsive-placement-result/v1',
