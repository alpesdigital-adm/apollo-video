...
export const FOUNDATION_CAPABILITIES = defineCapabilityRegistry([
  ...
  },
  {
    ...
    authMode: 'required',
    requiredScopes: ['projects:read'],
    outputSchemaRef: 'apollo://schemas/project-workspace/v3',
  ...
  },
  {
    ...
    description: 'Applies a typed spoken-content removal command against an immutable base version, persists the Command and creates a retimed ProjectVersion and EditPlan.',
    exposure: 'public',
    operationKind: 'command',
    authMode: 'required',
    requiredScopes: ['projects:write'],
    inputSchemaRef: 'apollo://schemas/apply-project-edit-command-request/v2',
    outputSchemaRef: 'apollo://schemas/project-edit-command-applied/v1',
