...
export const FOUNDATION_CAPABILITIES = defineCapabilityRegistry([
  ...
  },
  {
    ...
    authMode: 'required',
    requiredScopes: ['projects:read'],
    outputSchemaRef: 'apollo://schemas/project-workspace/v4',
  ...
  },
  {
    ...
    outputSchemaRef: 'apollo://schemas/public-operation-list/v3',
    ...
    queryParameters: [
      ...
      },
      {
        ...
        required: false,
        schema: { type: 'string', enum: ['artifact-render', 'media-ingest', 'project-proxy-render'] },
      },
      {
        name: 'targetId',
  ...
  },
  {
    ...
    authMode: 'required',
    requiredScopes: ['operations:read'],
    outputSchemaRef: 'apollo://schemas/public-operation-detail/v3',
