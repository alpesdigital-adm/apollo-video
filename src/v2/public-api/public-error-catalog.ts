...
export const PUBLIC_ERROR_CATALOG = definePublicErrorCatalog([
  ...
  },
  {
    status: 404, category: 'validation', codes: [
      ...
      'RENDER_ELEMENT_MAP_NOT_FOUND', 'SUBTITLE_SIDECAR_NOT_FOUND',
      ...
      'LOCALIZATION_CANONICAL_NOT_FOUND', 'LOCALIZATION_PROFILE_NOT_FOUND',
      ...
      'BATCH_EDIT_COMMAND_NOT_FOUND', 'EXPORT_MATRIX_PREFLIGHT_NOT_FOUND',
      'EXPORT_MATRIX_NOT_FOUND', 'API_CLIENT_NOT_FOUND', 'API_CREDENTIAL_NOT_FOUND',
  ...
  },
  {
    status: 409, category: 'conflict', codes: [
      ...
      'TOOL_CONFIRMATION_INVALID', 'SUBTITLE_SIDECAR_ALIGNMENT_MISMATCH',
    ],
  },
  {
