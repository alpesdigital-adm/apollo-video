...
const compiledProjectBriefExample = {
  ...canonicalProjectBriefExample,
  schemaVersion: 3,
  briefCompilation: {
    schemaVersion: 1,
    compiled: {
      schemaVersion: 1,
      fields: {
        audience: ['gestores'], offer: ['guia'], constraints: [], mustUse: [],
        avoid: [], tone: ['direto'], successCriteria: [],
      },
      evidence: [
        { field: 'audience', start: 9, end: 17, quote: 'gestores', confidence: 0.98 },
        { field: 'offer', start: 27, end: 31, quote: 'guia', confidence: 0.98 },
        { field: 'tone', start: 38, end: 44, quote: 'direto', confidence: 0.98 },
      ],
      conflicts: [], requiresReview: false,
      assumptions: ['constraints-not-specified', 'mustUse-not-specified', 'avoid-not-specified', 'successCriteria-not-specified'],
    },
    audit: {
      schemaVersion: 1, promptVersion: 'brief-compiler/v1',
      modelId: 'apollo-evidence-bound-brief-compiler', modelVersion: '1.0.0',
      compilerSchemaVersion: 1, inputHash: '1'.repeat(64),
      inputRedacted: 'Publico: gestores. Oferta: guia. Tom: direto.',
      outputRedacted: '{"schemaVersion":1}', outputHash: '2'.repeat(64),
    },
  },
}
...
export const PUBLIC_SCHEMA_EXAMPLES: Readonly<Record<string, readonly unknown[]>> =
  Object.freeze({
    'apollo://schemas/create-montage-alternatives-request/v1': [{ policyVersion: 'montage-alternatives-2026-08-v1', storyPlanRef: { id: 'story-plan-example-1', hash: 'a'.repeat(64) }, seeds: [{ id: 'candidate-example-1', seed: 'seed-example-1', mode: 'chronological', hook: { id: 'hook-example-1', selfContained: true }, blockOrder: ['block-hook', 'block-body'], permittedBlockOrders: [['block-hook', 'block-body']], assets: [{ id: 'asset-example-1', rightsApproved: true }], patternBreaks: [{ id: 'break-example-1', atMs: 1000, group: 'group-hook' }], maximumPatternBreaks: 3, confidence: 0.9, rubricSignals: { narrative: 0.9, objective: 0.8, continuity: 0.85, evidence: 0.8 } }] }],
    'apollo://schemas/montage-alternatives-created/v1': [{ data: { run: { schemaVersion: 'montage-alternative-run/v1', id: 'montage-run-example-1', workspaceId: 'workspace-example-1', projectId: 'project-example-1', policyVersion: 'montage-alternatives-2026-08-v1', storyPlanRef: { id: 'story-plan-example-1', hash: 'a'.repeat(64) }, selection: { schemaVersion: 'montage-selection/v1', policyVersion: 'montage-alternatives-2026-08-v1', rubric: { id: 'montage-rubric-v1', weights: { narrative: 0.35, objective: 0.25, continuity: 0.2, evidence: 0.2 }, tieTolerance: 0.000001, minimumConfidence: 0.7 }, status: 'selected', winnerId: 'candidate-example-1', reason: 'HIGHEST_RUBRIC_SCORE', diversity: { candidateCount: 1, eligibleCount: 1, uniqueHooks: 1, uniqueOrders: 1, uniqueAssetSets: 1, uniquePatternSets: 1, normalized: { hooks: 1, orders: 1, assets: 1, patterns: 1, overall: 1 } }, candidates: [{ schemaVersion: 'montage-candidate-seed/v1', id: 'candidate-example-1', seed: 'seed-example-1', storyPlanRef: { id: 'story-plan-example-1', hash: 'a'.repeat(64) }, mode: 'chronological', hook: { id: 'hook-example-1', selfContained: true }, blockOrder: ['block-hook', 'block-body'], permittedBlockOrders: [['block-hook', 'block-body']], assets: [{ id: 'asset-example-1', rightsApproved: true }], patternBreaks: [{ id: 'break-example-1', atMs: 1000, group: 'group-hook' }], maximumPatternBreaks: 3, confidence: 0.9, rubricSignals: { narrative: 0.9, objective: 0.8, continuity: 0.85, evidence: 0.8 }, seedHash: 'd'.repeat(64), status: 'eligible', hardGateResults: [{ code: 'HOOK_NOT_SELF_CONTAINED', passed: true, evidenceRefs: ['hook-example-1'] }, { code: 'ORDER_NOT_PERMITTED', passed: true, evidenceRefs: ['story-plan-example-1'] }, { code: 'RIGHTS_NOT_APPROVED', passed: true, evidenceRefs: ['asset-example-1'] }, { code: 'PATTERN_BUDGET_EXCEEDED', passed: true, evidenceRefs: ['break-example-1'] }, { code: 'STORY_BLOCK_COVERAGE_INVALID', passed: true, evidenceRefs: ['story-plan-example-1'] }], score: 0.8475, estimatedCost: 0.3, rejectionReasons: [], candidateHash: 'e'.repeat(64) }], selectionHash: 'b'.repeat(64) }, createdByClientId: 'client-example-1', createdAt: '2026-08-13T12:00:00.000Z', runHash: 'c'.repeat(64) }, replayed: false }, meta: { apiVersion: 'v1' } }],
    'apollo://schemas/montage-alternatives-read/v1': [{ data: { run: { schemaVersion: 'montage-alternative-run/v1', id: 'montage-run-example-1', workspaceId: 'workspace-example-1', projectId: 'project-example-1', policyVersion: 'montage-alternatives-2026-08-v1', storyPlanRef: { id: 'story-plan-example-1', hash: 'a'.repeat(64) }, selection: { schemaVersion: 'montage-selection/v1', policyVersion: 'montage-alternatives-2026-08-v1', rubric: { id: 'montage-rubric-v1', weights: { narrative: 0.35, objective: 0.25, continuity: 0.2, evidence: 0.2 }, tieTolerance: 0.000001, minimumConfidence: 0.7 }, status: 'selected', winnerId: 'candidate-example-1', reason: 'HIGHEST_RUBRIC_SCORE', diversity: { candidateCount: 1, eligibleCount: 1, uniqueHooks: 1, uniqueOrders: 1, uniqueAssetSets: 1, uniquePatternSets: 1, normalized: { hooks: 1, orders: 1, assets: 1, patterns: 1, overall: 1 } }, candidates: [{ schemaVersion: 'montage-candidate-seed/v1', id: 'candidate-example-1', seed: 'seed-example-1', storyPlanRef: { id: 'story-plan-example-1', hash: 'a'.repeat(64) }, mode: 'chronological', hook: { id: 'hook-example-1', selfContained: true }, blockOrder: ['block-hook', 'block-body'], permittedBlockOrders: [['block-hook', 'block-body']], assets: [{ id: 'asset-example-1', rightsApproved: true }], patternBreaks: [{ id: 'break-example-1', atMs: 1000, group: 'group-hook' }], maximumPatternBreaks: 3, confidence: 0.9, rubricSignals: { narrative: 0.9, objective: 0.8, continuity: 0.85, evidence: 0.8 }, seedHash: 'd'.repeat(64), status: 'eligible', hardGateResults: [{ code: 'HOOK_NOT_SELF_CONTAINED', passed: true, evidenceRefs: ['hook-example-1'] }, { code: 'ORDER_NOT_PERMITTED', passed: true, evidenceRefs: ['story-plan-example-1'] }, { code: 'RIGHTS_NOT_APPROVED', passed: true, evidenceRefs: ['asset-example-1'] }, { code: 'PATTERN_BUDGET_EXCEEDED', passed: true, evidenceRefs: ['break-example-1'] }, { code: 'STORY_BLOCK_COVERAGE_INVALID', passed: true, evidenceRefs: ['story-plan-example-1'] }], score: 0.8475, estimatedCost: 0.3, rejectionReasons: [], candidateHash: 'e'.repeat(64) }], selectionHash: 'b'.repeat(64) }, createdByClientId: 'client-example-1', createdAt: '2026-08-13T12:00:00.000Z', runHash: 'c'.repeat(64) } }, meta: { apiVersion: 'v1' } }],
    ...
    'apollo://schemas/sandbox-provider-execution-page/v2': [
      {
        data: {
          entries: [
            {
            ...
            },
            {
              ...
              outputHash: 'b'.repeat(64),
              units: 120,
              cost: { currency: 'USD', minorUnits: 240 },
              externalCalls: 0,
    ...
    'apollo://schemas/project-workspace/v10': [
      {
        data: {
          project: {
            id: projectId, workspaceId, name: 'Anuncio com briefing compilado', status: 'draft',
            objective: 'discovery', format: '9:16', locale: 'pt-BR', createdAt,
            visibleState: {
              schemaVersion: 'visible-state/v1', label: 'draft', tone: 'neutral',
              progress: { mode: 'not-started', percent: 0 }, primaryAction: 'open-result',
          ...
          version: {
            id: 'project-version-example-brief-2', sequence: 2,
            baseHash: '3'.repeat(64), createdAt,
            visibleState: {
              schemaVersion: 'visible-state/v1', label: 'current', tone: 'info',
              progress: { mode: 'none' }, primaryAction: 'open-result',
              availableActions: ['open-result'], terminal: false,
