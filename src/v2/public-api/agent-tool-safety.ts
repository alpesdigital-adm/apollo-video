...
export function createFoundationAgentToolSafety(
  ...
  return defineAgentToolSafetyRegistry(capabilities, {
    ...
    'apollo.projects.color-plan.set': {
      impact: 'bounded', confirmation: 'none',
      reason: 'Creates one exact-version ColorPlan Command, immutable ProjectVersion and bounded proxy operation; all source colorimetry and compiled target hashes are revalidated server-side.',
    },
