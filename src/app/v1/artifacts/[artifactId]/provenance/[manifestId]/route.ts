...
import { readMediaArtifactProvenanceService } from '@/v2/application/read-media-artifact-provenance'
...
export async function GET(
  ...
  try {
    ...
    const provenance = await readProvenance(actor.workspaceId, artifactId, manifestId)
    return NextResponse.json(presentSuccess(provenance), {
