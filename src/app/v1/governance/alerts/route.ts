...
import { listGovernanceAlertsService } from '@/v2/application/list-governance-alerts'
import { createGovernanceAdmissionRepository } from '@/v2/infrastructure/repository-factory'
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const result = await listGovernanceAlertsService({
