...
} from '@/v2/application/list-sandbox-provider-executions'
import {
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const result = await listSandboxProviderExecutionsService({
      repository: createSandboxProviderExecutionRepository(),
    })({
      actor,
