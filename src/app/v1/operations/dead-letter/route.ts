...
import { listDeadLetterOperationsService } from '@/v2/application/list-dead-letter-operations'
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const allowedParameters = new Set(['limit', 'after', 'type', 'projectId', 'targetId'])
    ...
    const list = listDeadLetterOperationsService({
