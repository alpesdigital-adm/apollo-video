...
- [ ] Mapear estado técnico para label, progresso e ação na UI. Parcial F0.029: operações v7, batch v2, invalidations v2, artifact v3, project list v4, create v4, duplicate v2, workspace v7, review v3, commands v7/result v6 e manual edit v3 retornam projeções visíveis aditivas; versões anteriores permanecem publicadas. ProjectVersion atual abre o resultado; superseded abre preview histórico somente quando disponível. Evidência: T-FR-236 e ADR-133.
- [ ] Testar sucesso, espera, retry, cancel, falha parcial, stale e conclusão. Parcial F0.029: além das coberturas anteriores, ProjectVersion prova current/superseded, preview histórico disponível/ausente, create/duplicate/workspace, os três branches de Commands e apply/undo/redo/restore de manual edit, com imutabilidade e adulteração de contrato. PostgreSQL E2E dos demais writers, patch/LUT, transições de artifact, deploy e aceite permanecem abertos. Evidência: T-FR-236 e ADR-133.
