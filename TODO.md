...
- [ ] Materializar URLs/paths, fonts, LUTs e assets antes de iniciar render. Parcial F0-023/FR-181: worker relê autorização/payload/política, adapter local resolve vídeo/áudio/imagem sob raiz privada e reconstrói LUTs por versão/intensidade imutáveis em cache content-addressed, verificando hash e tamanho antes de entregar somente a lease ao renderer real; faltam storage S3-compatible/signed URLs, fonts e data. Evidência: T-FR-234 e ADR-133.
