...
- [ ] Testar alteração de legenda, crop, B-roll e source transcript. Parcial F0-027: crop manual agora é uma operação tipada com retângulo normalizado, persiste no clip/ProjectVersion, aparece na timeline e na UI, invalida somente o range e formato declarados e chega ao renderer V2; golden FFmpeg real comprova o crop somente no range central e o reuso do prefixo/sufixo. A edição manual de texto já materializa o cue no EditPlan, restringe o impacto aos frames exatos do cue e o golden real comprova pixels alterados somente nesse range, com prefixo/sufixo idênticos. O E2E PostgreSQL/API de crop foi ampliado, mas não executado neste host. B-roll e source transcript continuam abertos, assim como deploy/aceite. Evidência: T-FR-233 e ADR-133.
