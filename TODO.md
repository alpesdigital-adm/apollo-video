...
- reconciliação de custo efetivo por client, anomaly agregado de error-rate e conexão do fake sandbox ao provider runtime continuam pendentes; F0.100–F0.103 permanecem abertas.
...
- o teste não foi executado neste host por ausência de PostgreSQL local isolado; custo efetivo reconciliado, anomaly agregado, sandbox provider roteado, deploy e aceite permanecem pendentes, então F0.100 continua aberta.
