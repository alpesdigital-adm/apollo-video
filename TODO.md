...
- [ ] Testar sucesso, espera, retry, cancel, falha parcial, stale e conclusão. Parcial F0.029: operações cobrem sete estados; batch cobre falha parcial; invalidation cobre stale relacional; artifact cobre seu lifecycle; Project cobre as 14 fases, imutabilidade, correspondência status/label/ação e estado persistido inventado fail-closed em create/list/workspace. Matriz de transições persistidas, estado de versão, PostgreSQL E2E, deploy e aceite permanecem abertos. Evidência: T-FR-236 e ADR-133.
