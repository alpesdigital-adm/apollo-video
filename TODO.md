...
- lifecycle público de policies, reconciliação de custo efetivo por client, anomaly agregado de error-rate e conexão do fake sandbox ao provider runtime continuam pendentes; F0.100–F0.103 permanecem abertas.
