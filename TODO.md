...
- **300 de 1.259 microtarefas verificadas como efetivamente entregues (23,8%, arredondamento conservador)**;
- **959 microtarefas abertas ou aguardando nova comprovação**;
...
- [x] Publicar examples validados e documentação por build. Evidência F0.035: os 385 examples dos 340 schemas são validados por Ajv Draft 2020-12; `prebuild` gera deterministicamente OpenAPI + todos os schemas + manifest com hashes/bytes/contagens, e o CI publica 342 arquivos como artefato versionado pelo SHA. O run `30820090576` aprovou o bundle `4bb6269d...`, o upload oficial, build e matriz completa. Evidência: `build-public-api-documentation.mjs`, T-FR-241 e ADR-134.
