...
- [ ] Materializar URLs/paths, fonts, LUTs e assets antes de iniciar render. Parcial F0-023/FR-181/FR-234: worker relê autorização/payload/política; adapter local resolve vídeo/áudio/imagem sob raiz privada e reconstrói LUTs por versão/intensidade imutáveis; adapter S3-compatible relê identidade no Postgres, exige checksum/tamanho/versionId exatos e entrega presigned GET com máximo de 30–300s, encurtado para nunca ultrapassar a autorização e presente somente na lease. Smoke Remotion real consumiu o input HTTP versionado. Faltam fonts/data, execução contra MinIO/S3 real e implantação. Evidência: T-FR-234 e ADR-133.
